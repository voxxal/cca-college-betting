defmodule CcaCollegeBettingWeb.CoreComponents do
  @moduledoc """
  ...
  import CcaCollegeBettingWeb.Gettext
    ...
    <button
      ...
      class={[
        ...
        if @disabled do
          ...
          "active:text-white/80 hover:bg-zinc-700"
        end,
        @class
      ]}
      disabled={@disabled}
  ...
  attr :disabled, :boolean, default: false, doc: "the disabled flag"
  attr :rest, :global, include: ~w(autocomplete cols form max maxlength min minlength
  ...
  def table(assigns) do
    ...
    ~H"""
    <div class="px-4 overflow-y-auto overflow-y-hidden sm:overflow-visible sm:px-0">
      <table class="w-full mt-11">
        ...
        >
          <tr
            ...
            class={@row_click && "group hover:bg-zinc-50"}
          >
            <td
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CcaCollegeBettingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CcaCollegeBettingWeb.Gettext, "errors", msg, opts)
    end
  end
